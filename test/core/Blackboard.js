...
suite('Core: Blackboard', function() {
    ...
    test('Tree memory initialization', function() {
        ...
        assert.isDefined(blackboard.get('var1', 'tree1'));
        assert.isDefined(blackboard.get('nodeMemory', 'tree1'));
        assert.isDefined(blackboard.get('openNodes', 'tree1'));
        assert.isDefined(blackboard.get('traversalCycle', 'tree1'));
    });
